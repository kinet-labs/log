...
High-performance, structured, leveled logging library with context injection. Based on [zerolog](https://github.com/rs/zerolog) with additional geth-style API support.
...
```bash
go get github.com/kinet-labs/logger
```
...
```go
import "github.com/kinet-labs/logger"
...
|---------|------|-------|--------|
| **kinet-labs/logger** | 8 ns/op | 0 B/op | 0 allocs/op |
